...
# Title: QAM Noise Constellations
...
class TobiasQAM(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "QAM Noise Constellations", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QAM Noise Constellations")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "TobiasQAM")
        ...
        self.qtgui_const_sink_x_0 = qtgui.const_sink_c(
            mod_points, #size
            'Constellation with Noise Added', #name
            1, #number of inputs
            None # parent
        )
        ...
        self.blocks_unpacked_to_packed_xx_0 = blocks.unpacked_to_packed_bb(bits_chunk, gr.GR_MSB_FIRST)
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_char*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_packed_to_unpacked_xx_0 = blocks.packed_to_unpacked_bb(bits_chunk, gr.GR_MSB_FIRST)
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\tobia\\Documents\\QAMinput.txt', False)
        self.blocks_file_sink_1.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\tobia\\Documents\\QAMoutput.txt', False)
        ...
        self.connect((self.analog_random_source_x_0, 0), (self.blocks_file_sink_1, 0))
        ...
        self.connect((self.digital_constellation_encoder_bc_0, 0), (self.qtgui_const_sink_x_0_0, 0))
    ...
    def get_mod_points(self):
        return self.mod_points

    def set_mod_points(self, mod_points):
        self.mod_points = mod_points

    def get_bits_chunk(self):
        return self.bits_chunk

    def set_bits_chunk(self, bits_chunk):
        self.bits_chunk = bits_chunk
...
def main(top_block_cls=TobiasQAM, options=None):
